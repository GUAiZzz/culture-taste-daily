...
Hamburger Bahnhof 的官方页面确认，展览 **Ryuichi Sakamoto — Seeing Sound, Hearing Time** 于 9 月 10 日 19:00 开幕，展期从 9 月 11 日持续到 2027 年 2 月 28 日。展览把七件作品放进五个大型装置，开幕现场还有 Carsten Nicolai 出席；开幕免费且无需预约。

这组事实已经足够改变观看预期：这里不是把音乐家的作品挂在墙上，而是把声音变成一个需要进入的环境。官方东京展览资料还记录了 Sakamoto 用自然、地震数据和电磁波进入声音与图像的实践线索；在 **IS YOUR TIME** 中，钢琴的声音也不再只由人的手指决定。

因此，“听见”在这里不是按下播放键，而是接受一套空间和数据的约束。声音把观看者的位置、停留时间和注意力一起变成作品的一部分。我们仍不能从开幕公告推导真实观众的感受，但可以确认：作品先规定了你如何靠近它。

来源：[Hamburger Bahnhof / Staatliche Museen zu Berlin 官方开幕页](https://www.smb.museum/en/events/detail/opening-of-the-exhibition-ryuichi-sakamoto-seeing-sound-hearing-time-2026-09-10-190000-161025/)；[Tokyo Museum of Contemporary Art 官方展览资料](https://www.mot-art-museum.jp/en/exhibitions/RS_Handout_EN.pdf)

## Stanley Whitney：颜色在互相叫下一格

Gagosian Hong Kong 的官方页面确认，Stanley Whitney 的 **Isn’t Love the Strangest Thing** 于 9 月 10 日开幕，展期至 11 月 7 日。这是他在亚洲的首次个展。页面把作品写成松散的网格、行列与水平色带，也明确提到颜色会彼此“呼叫”，形成新的节奏；展览标题来自 Duke Ellington 的爵士标准曲。

这里的关键不是“色彩很丰富”，而是颜色之间怎样给眼睛发出下一条指令。Whitney 的色块没有被压成一个稳定的中心，观看会在相邻的块、行和空隙之间来回跳动。网格不是背景，它是视线的编排器；每一块颜色既是对象，也是把注意力递给下一块的动作。

这让抽象绘画和音乐发生的关系更具体：不是把画面比喻成音乐，而是让“节奏”落到尺度、间距和相邻颜色上。Gagosian 的页面确认了作品和展期，至于每个观众是否真的会被这种呼叫带走，仍然要等眼睛在现场完成一次移动。

来源：[Gagosian Hong Kong 官方展览页](https://gagosian.com/exhibitions/2026/stanley-whitney-isnt-love-the-strangest-thing/)
...
CFDA 的官方初步日程确认，2026 年 9 月 10 日的纽约时装周以 Henry Zankov 首次担任 Diane von Furstenberg 艺术总监的发布开始。整个 SS27 周期共有 70 场 show 和 presentation；CFDA 还说明，本季执行 fur-free policy，并因 9 月 11 日纪念日调整周五日程。

Wallpaper 的独立日程梳理把 Zankov 的身份放回针织设计师的路径中。这个交接值得看的地方，不是“新任艺术总监”这句职位新闻，而是品牌语言能否被一种具体的材料实践重新组织。针织天然把结构、拉伸、身体距离和运动写在一起；当它进入 DVF 的舞台，品牌的记忆就不再只是图案或姓名，而要经过一套新的身体尺度。

这里仍需留出边界：首秀尚未发生，不能提前把系列评价写成结果。现在能确认的只是时间、角色和舞台位置；真正的判断要等服装如何让身体移动、如何处理 DVF 的既有符号之后再来。

来源：[CFDA 官方纽约时装周日程](https://cfda.com/news/view-the-preliminary-september-2026-official-nyfw-schedule/)；[Wallpaper 独立日程报道](https://www.wallpaper.com/fashion-beauty/womens-fashion-week-ss-2027-what-to-expect-schedule-calendar)
